        ...
        <div class="container-fluid py-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted">Dossiers validés par les directeurs, en attente de finalisation.</p>
                </div>
                <button class="btn btn-outline-primary" (click)="loadInscriptions()">
            ...
            @if (isLoading()) {
                ...
                <div class="alert alert-info shadow-sm">
                    <i class="bi bi-info-circle-fill me-2"></i> Aucun dossier en attente.
                </div>
            } @else {
                                ...
                                @for (ins of inscriptions(); track ins.id) {
                                    <tr>
                                        ...
                                        <td class="text-end pe-4">
                                            <div class="btn-group">
                                                <button class="btn btn-success btn-sm" (click)="valider(ins.id)" title="Valider">
                                                    <i class="bi bi-check-lg"></i> Valider
                                                </button>
                                                <button class="btn btn-danger btn-sm" (click)="rejeter(ins.id)" title="Rejeter">
...
export class AdminInscriptionValidationComponent implements OnInit {
    ...
    loadInscriptions() {
        ...
        // On charge les dossiers qui ont été validés par les directeurs
